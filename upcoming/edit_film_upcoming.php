...
<body>
    ...
    <form method="POST" action="../upcoming/proses_edit_upcoming.php" enctype="multipart/form-data">
        <section class="base">
            <div style="margin-bottom: 10px;">
                <label style="font-weight:bolder; margin-bottom:4px" >Poster</label>
                <img src="../poster/temp/<?php echo $data['poster']; ?>" style="width:120px; float: left; margin-bottom: 5px;">
