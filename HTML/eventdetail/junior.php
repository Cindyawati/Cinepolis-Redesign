    ...
    <body class="body">
        ...
        <div class="container">
            <div class="row">
                <div class="col-5">
                    <div class="row">
                        <img class="event-photo" src="../../asset/event/CINEPOLIS JUNIOR.jpg" alt="" srcset="">
                    </div>
                </div>
                <div class="col-6 cinema-description">
                    <p class="cinema-name">CINÉPOLIS JUNIOR</p>
                    <div class="desc">
                        <p>Hai mommy and daddy!</p>
                        <br>
                        <p>Ada kabar gembira untuk kalian nih! Sekarang ini di Cinépolis Junior dimulai dengan harga <b>Rp 30.000</b> saja, mommy and daddy sudah dapat mengajak si kecil untuk menonton dan bermain loh. Playground tiket akan dikenakan biaya sebesar <b>Rp 60.000</b> untuk anak diatas <b>1 tahun sampai dengan dibawah 12 tahun.</b></p>
                        <br>
                        <p>Jangan lupa juga untuk pakai kaos kaki ya! Kaos kaki diwajibkan untuk si kecil, mommy dan daddy juga ya!</p>
                        <br>
                        <p>Yuk, pesan tiket untuk menonton di Cinépolis Junior sekarang!</p>
                    </div>
                    <div class="desc">
                        <p style="font-weight: bolder;">Berikut ini adalah Mall yang memiliki Cinépolis Junior:</p>
                        <ol>
                            <li>MAXXBOX LIPPO VILLAGE</li>
                            <li>PLUIT VILLAGE</li>
                            <li>SUN PLAZA MEDAN</li>
                            <li>LIVING WORLD PEKANBARU</li>
                        </ol> 
                    </div>
                </div>
            </div>
