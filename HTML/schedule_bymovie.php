...
<html lang="en">
    ...
    <body class="body">
        ...
        <div class="container event">
            <h4 id="cinema-title" class="now-showing"><b><?php echo str_replace ("-", " ", $_GET['name']);?></p></b></h4>
        </div>
        ...
        <div style="display: none;" id="bekasi-section">
            ...
            <div class="container schedule-section">
                ...
                <div class="row schedule-item">
                    <div class="col-4">
                        <p class="schedule-movie-title">Blu Plaza | Bekasi Timur</p>
                    </div>
                    <div class="col-8">
                    <p class="schedule-cinema-class">Regular</p>
                        ...
                        <a href="select_seat.php?name=<?php echo $_GET['name'] ?>&cinema=BLUE-PLAZA-|-BEKASI-TIMUR&time=20:50&price=40,000"  class="btn btn-primary schedule-button">
                            <p>20:50 (2D)</p>
                            <p>IDR 40.000</p>
                        </a>
                    </div>
        ...
        <div style="display: none;" id="bogor-section">
            <div class="container event">
                <h4 id="cinema-title" class="now-showing"><b></b></h4>
            </div>
            ...
            <div class="container schedule-section">
                ...
                <div class="row schedule-item">
                    <div class="col-4">
                        <p class="schedule-movie-title">Bellanova Country Mall | Bogor</p>
                    </div>
                    <div class="col-8">
                    <p class="schedule-cinema-class">Regular</p>
                        <a href="#" class="btn btn-primary schedule-button-unavailable">
                        ...
                        <a href="select_seat.php?cinema=BELLANOVA-COUNTRY-MALL-|-BOGOR&name=<?php echo $_GET['name'] ?>&time=20:50&price=40,000"  class="btn btn-primary schedule-button">
                            <p>20:50 (2D)</p>
                            <p>IDR 40.000</p>
                        </a>
                        <a href="select_seat.php?cinema=BELLANOVA-COUNTRY-MALL-|-BOGOR&name=<?php echo $_GET['name'] ?>&time=22:20&price=40,000"  class="btn btn-primary schedule-button">
                            <p>22:20 (2D)</p>
                            <p>IDR 40.000</p>
                        </a>
                    </div>
            ...
            <div class="container schedule-section">
                <div class="row schedule-item">
                    <div class="col-4">
                        <p class="schedule-movie-title">Lippo Plaza Ekalokasari | Bogor</p>
                    </div>
                    <div class="col-8">
                    <p class="schedule-cinema-class">Regular</p>
                        <a href="#" class="btn btn-primary schedule-button-unavailable">
                        ...
                        <a href="select_seat.php?cinema=LIPPO-PLAZA-EKALOKASARI-|-BOGOR&name=<?php echo $_GET['name'] ?>&time=20:50&price=40,000"  class="btn btn-primary schedule-button">
                            <p>20:50 (2D)</p>
                            <p>IDR 40.000</p>
                        </a>
                    </div>
        ...
        <div style="display: none;" id="denpasar-section">
            ...
            <div class="container schedule-section">
                ...
                <div class="row schedule-item">
                    <div class="col-4">
                        <p class="schedule-movie-title">Lippo Mall Kuta | Kuta, Bali</p>
                    </div>
                    <div class="col-8">
                    <p class="schedule-cinema-class">Regular</p>
                        <a href="#" class="btn btn-primary schedule-button-unavailable">
                        ...
                        <a href="select_seat.php?cinema=LIPPO-MALL-KUTA-|-KUTA,-BALI&name=<?php echo $_GET['name'] ?>&time=20:50&price=40,000"  class="btn btn-primary schedule-button">
                            <p>20:50 (2D)</p>
                            <p>IDR 40.000</p>
                        </a>
                    </div>
        ...
        <div style="display: none;" id="malang-section">
            ...
            <div class="container schedule-section">
                ...
                <div class="row schedule-item">
                    <div class="col-4">
                        <p class="schedule-movie-title">Malang Town Square | Malang</p>
                    </div>
                    <div class="col-8">
                    <p class="schedule-cinema-class">Regular</p>
                        <a href="#" class="btn btn-primary schedule-button-unavailable">
                        ...
                        <a href="select_seat.php?cinema=MALANG-TOWN-SQUARE-|-MALANG&name=<?php echo $_GET['name'] ?>&time=20:50&price=40,000"  class="btn btn-primary schedule-button">
                            <p>20:50 (2D)</p>
                            <p>IDR 40.000</p>
                        </a>
                        <a href="select_seat.php?cinema=MALANG-TOWN-SQUARE-|-MALANG&name=<?php echo $_GET['name'] ?>&time=21:40&price=40,000"  class="btn btn-primary schedule-button">
                            <p>21:40 (2D)</p>
                            <p>IDR 40.000</p>
                        </a>
                    </div>
        ...
        <div style="display: none;" id="medan-section">
            ...
            <div class="container schedule-section">
                ...
                <div class="row schedule-item">
                    <div class="col-4">
                        <p class="schedule-movie-title">Sun Plaza Medan | Medan</p>
                    </div>
                    <div class="col-8">
                    <p class="schedule-cinema-class">Regular</p>
                        <a href="#" class="btn btn-primary schedule-button-unavailable">
                        ...
                        <a href="select_seat.php?cinema=SUN-PLAZA-MEDAN-|-MEDAN&name=<?php echo $_GET['name'] ?>&time=20:50&price=40,000"  class="btn btn-primary schedule-button">
                            <p>20:50 (2D)</p>
                            <p>IDR 40.000</p>
                        </a>
                    </div>
        ...
        <div style="display: none;" id="jakpus-section">
            ...
            <div class="container schedule-section">
                ...
                <div class="row schedule-item">
                    <div class="col-4">
                        <p class="schedule-movie-title">Gajah Mada Plaza | Jakarta Pusat</p>
                    </div>
                    <div class="col-8">
                    <p class="schedule-cinema-class">Regular</p>
                        <a href="#" class="btn btn-primary schedule-button-unavailable">
                        ...
                        <a href="select_seat.php?cinema=GAJAH-MADA-PLAZA-|-JAKARTA-PUSAT&name=<?php echo $_GET['name'] ?>&time=20:50&price=40,000"  class="btn btn-primary schedule-button">
                            <p>20:50 (2D)</p>
                            <p>IDR 40.000</p>
                        </a>
                        <a href="select_seat.php?cinema=GAJAH-MADA-PLAZA-|-JAKARTA-PUSAT&name=<?php echo $_GET['name'] ?>&time=22:40&price=40,000"  class="btn btn-primary schedule-button">
                            <p>22:40 (2D)</p>
                            <p>IDR 40.000</p>
                        </a>
                    </div>
        ...
        <div style="display: none;" id="jaksel-section">
            <div class="container schedule-section">
                ...
                <div class="row schedule-item">
                    <div class="col-4">
                        <p class="schedule-movie-title">Plaza Semanggi | Jakarta Selatan</p>
                    </div>
                    <div class="col-8">
                    <p class="schedule-cinema-class">Regular</p>
                        <a href="#" class="btn btn-primary schedule-button-unavailable">
                        ...
                        <a href="select_seat.php?cinema=PLAZA-SEMANGGI-|-JAKARTA-SELATAN&name=<?php echo $_GET['name'] ?>&time=20:50&price=40,000"  class="btn btn-primary schedule-button">
                            <p>20:50 (2D)</p>
                            <p>IDR 40.000</p>
                        </a>
                        <a href="select_seat.php?cinema=PLAZA-SEMANGGI-|-JAKARTA-SELATAN&name=<?php echo $_GET['name'] ?>&time=22:40&price=40,000"  class="btn btn-primary schedule-button">
                            <p>22:40 (2D)</p>
                            <p>IDR 40.000</p>
                        </a>
                    </div>
        ...
        <div style="display: none;" id="jaktara-section">
            ...
            <div class="container schedule-section">
                ...
                <div class="row schedule-item">
                    <div class="col-4">
                        <p class="schedule-movie-title">Mangga Dua Square | Jakarta Utara</p>
                    </div>
                    <div class="col-8">
                    <p class="schedule-cinema-class">Regular</p>
                        <a href="#" class="btn btn-primary schedule-button-unavailable">
                        ...
                        <a href="select_seat.php?cinema=MANGGA-DUA-SQUARE-|-JAKARTA-UTARA&name=<?php echo $_GET['name'] ?>&time=20:50&price=40,000"  class="btn btn-primary schedule-button">
                            <p>20:50 (2D)</p>
                            <p>IDR 40.000</p>
                        </a>
                    </div>
