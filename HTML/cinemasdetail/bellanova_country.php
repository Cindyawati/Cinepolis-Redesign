...
<html lang="en">
    <head>
        ...
        <title>Cinépolis - Bellanova Country Mall</title>
    </head>
    ...
    <body class="body">
        ...
        <div class="container">
            <div class="row">
                <div class="col-6">
                    <div class="row">
                        <img class="cinema-photo" src="../../asset/cinemas/Bellanova Country Mall.jpg" alt="" srcset="">
                    </div>
                ...
                <div class="col-6 cinema-description">
                    <p class="cinema-name">Bellanova Country Mall</p>
                    <div class="desc">
                        <p class="title">Address</p>
                        <p>Bellanova Country Mall, Lt. Ground (GA1), Jl. MH. Thamrin No. 8 Sentul Selatan. RT 002/ RW 008, Desa Cipambuan Kec. Babakan Madang Kab. Bogor, Jawa barat , Bogor</p>
                    </div>
                    <div class="desc">
