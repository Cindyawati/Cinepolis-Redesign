...
<html lang="en">
    <head>
        ...
        <title>Cinépolis - Gajah Mada Plaza</title>
    </head>
    ...
    <body class="body">
        ...
        <div class="container">
            <div class="row">
                <div class="col-6">
                    <div class="row">
                        <img class="cinema-photo" src="../../asset/cinemas/Gajah Mada.png" alt="" srcset="">
                    </div>
                ...
                <div class="col-6 cinema-description">
                    <p class="cinema-name">Gajah Mada Plaza</p>
                    <div class="desc">
                        <p class="title">Address</p>
                        <p>Gajah Mada Plaza, Jl. Gajah Mada No. 19-26 Jakarta Pusat, Jakarta Pusat</p>
                    </div>
                    <div class="desc">
