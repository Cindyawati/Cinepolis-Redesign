...
<html lang="en">
    <head>
        ...
        <title>Cinépolis - Plaza Semanggi</title>
    </head>
    ...
    <body class="body">
        ...
        <div class="container">
            <div class="row">
                <div class="col-6">
                    <div class="row">
                        <img class="cinema-photo" src="../../asset/cinemas/Plaza Semanggi.jpg" alt="" srcset="">
                    </div>
                ...
                <div class="col-6 cinema-description">
                    <p class="cinema-name">Plaza Semanggi</p>
                    <div class="desc">
                        <p class="title">Address</p>
                        <p>Kawasan GRANADHA, lantai 5, Plaza Semanggi, Jalan Jenderal Sudirman Kavling 10, Jakarta Selatan, Jakarta Selatan</p>
                    </div>
                    <div class="desc">
