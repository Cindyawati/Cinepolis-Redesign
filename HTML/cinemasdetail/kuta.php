...
<html lang="en">
    <head>
        ...
        <title>Cinépolis - Lippo Mall Kuta</title>
    </head>
    ...
    <body class="body">
        ...
        <div class="container">
            <div class="row">
                <div class="col-6">
                    <div class="row">
                        <img class="cinema-photo" src="../../asset/cinemas/Lippo Mall Kuta.jpg" alt="" srcset="">
                    </div>
                ...
                <div class="col-6 cinema-description">
                    <p class="cinema-name">Lippo Mall Kuta</p>
                    <div class="desc">
                        <p class="title">Address</p>
                        <p>Jalan Kartika Plaza Lingkar Segara, Kuta, Bali, Unit LG-15., Denpasar</p>
                    </div>
                    <div class="desc">
