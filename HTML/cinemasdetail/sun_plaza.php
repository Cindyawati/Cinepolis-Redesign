...
<html lang="en">
    <head>
        ...
        <title>Cinépolis - Sun Plaza Medan</title>
    </head>
    ...
    <body class="body">
        ...
        <div class="container">
            <div class="row">
                <div class="col-6">
                    <div class="row">
                        <img class="cinema-photo" src="../../asset/cinemas/Sun Plaza Medan.jpg" alt="" srcset="">
                    </div>
                    <div class="row feature-body">
                        ...
                        <span class="feature-title"><img class="feature-image" src="../../asset/class/MACRO XE.gif">Macro XE</span>
                        <span class="feature-title"><img class="feature-image" src="../../asset/class/VIP.gif">VIP</span>
                        <span class="feature-title"><img class="feature-image" src="../../asset/class/Junior.gif">Junior</span>
                    </div>
                </div>
                <div class="col-6 cinema-description">
                    <p class="cinema-name">Sun Plaza Medan</p>
                    <div class="desc">
                        <p class="title">Address</p>
                        <p>Jalan K.H Zainul Arifin no.7 ,Level 4 zone A-22,kelurahan madras hulu, Kec Medan Polonia, Medan</p>
                    </div>
                    <div class="desc">
                        <p class="title">Working Hours</p>
                        <p>Weekdays: 10:00 AM - 00:00 AM</p>
                        <p>Weekend : 10:00 AM - 01:00 AM (Midnite Show)</p>
                    </div>
                    <div class="desc">
                    ...
                    <div class="desc">
                        ...
                        <p class="price-title">Macro XE</p>
                        <div class="row">
                            <div class="col">
                                <p>Monday - Thursday</p>
                                <p>Friday</p>
