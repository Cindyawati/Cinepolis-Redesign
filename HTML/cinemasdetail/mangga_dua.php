...
<html lang="en">
    <head>
        ...
        <title>Cinépolis - Mangga Dua Square</title>
    </head>
    ...
    <body class="body">
        ...
        <div class="container">
            <div class="row">
                <div class="col-6">
                    <div class="row">
                        <img class="cinema-photo" src="../../asset/cinemas/Mangga Dua Square.jpg" alt="" srcset="">
                    </div>
                ...
                <div class="col-6 cinema-description">
                    <p class="cinema-name">Mangga Dua Square</p>
                    <div class="desc">
                        <p class="title">Address</p>
                        <p>Mangga Dua Square Lt 3 Hall A Jl. Gunung Sahari Raya No.1 Pademangan Jakarta-Utara , Jakarta Utara</p>
                    </div>
                    <div class="desc">
                        <p class="title">Working Hours</p>
                        <p>Weekdays: 10:00 AM - 00:00 AM</p>
                        <p>Weekend : 10:00 AM - 01:00 AM</p>
                    </div>
                    <div class="desc">
