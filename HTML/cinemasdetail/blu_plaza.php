...
<html lang="en">
    <head>
        ...
        <title>Cinépolis - Blu Plaza</title>
    </head>
    ...
    <body class="body">
        ...
        <div class="container">
            <div class="row">
                <div class="col-6">
                    <div class="row">
                        <img class="cinema-photo" src="../../asset/cinemas/Blu Plaza.jpg" alt="" srcset="">
                    </div>
                ...
                <div class="col-6 cinema-description">
                    <p class="cinema-name">Blu Plaza</p>
                    <div class="desc">
                        <p class="title">Address</p>
                        <p>Jl. Chairil anwar no.27-36 RT 004/009, Margahayu, kec. Bekasi Timur, kota Bekasi, Jawa Barat, Bekasi</p>
                    </div>
                    <div class="desc">
                        <p class="title">Working Hours</p>
                        <p>Weekdays: 10:00 AM - 19:00 PM</p>
                        <p>Weekend : 10:00 AM - 20:00 PM</p>
                    </div>
                    <div class="desc">
