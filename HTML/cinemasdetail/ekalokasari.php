...
<html lang="en">
    <head>
        ...
        <title>Cinépolis - Lippo Plaza Ekalokasari</title>
    </head>
    ...
    <body class="body">
        ...
        <div class="container">
            <div class="row">
                <div class="col-6">
                    <div class="row">
                        <img class="cinema-photo" src="../../asset/cinemas/Lippo Plaza Ekalokasari.jpg" alt="" srcset="">
                    </div>
                    <div class="row feature-body">
                        ...
                        <span class="feature-title"><img class="feature-image" src="../../asset/class/JOMO.gif">Jomo</span>
                    </div>
                </div>
                <div class="col-6 cinema-description">
                    <p class="cinema-name">Lippo Plaza Ekalokasari</p>
                    <div class="desc">
                        <p class="title">Address</p>
                        <p>Jalan Siliwangi 123 L3M #5 Kelurahan Sukasari Kecamatan Bogor Timur, Bogor</p>
                    </div>
                    <div class="desc">
                    ...
                    <div class="desc">
                        ...
                        <p class="price-title">Couple Seat</p>
                        <div class="row">
                            <div class="col">
                                <p>Monday - Thursday</p>
                                <p>Friday</p>
