...
<html lang="en">
    ...
    <body class="body">
        ...
        <?php
            $query = "SELECT * FROM upcoming ORDER BY id ASC LIMIT 1 OFFSET 2";
        ...
        <div class="container jumbotron-detail fantasticbeats p-5 mb-2 rounded-3 d-flex justify-content-center">
        <div class="container-fluid">
            <div class="col-4">
                <h1 class="banner-title-long">
                    <?php echo $row['title']; ?>
                </h1>
            </div>
        ...
        <div class="container movies-detail">
            <div class="row">
                ...
                <div class="col-3 trailer">
                    ...
                    <iframe class="div-round" src="https://www.youtube.com/embed/DaM_wL1ZOM4" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                </div>
            </div>
        </div>
