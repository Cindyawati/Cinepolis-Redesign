...
<html lang="en">
    ...
    <body class="body">
        ...
        <?php
            $query = "SELECT * FROM upcoming ORDER BY id ASC LIMIT 1 OFFSET 1";
        ...
        <div class="container jumbotron-detail dominion p-5 mb-2 rounded-3 d-flex justify-content-center">
        <div class="container-fluid">
            <div class="col-4">
        ...
        <div class="container movies-detail">
            <div class="row">
                ...
                <div class="col-3 trailer">
                    ...
                    <iframe class="div-round" src="https://www.youtube.com/embed/fb5ELWi-ekk" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                </div>
            </div>
        </div>
