...
<html lang="en">
    ...
    <body class="body">
        ...
        <?php
            $query = "SELECT * FROM movie ORDER BY id ASC LIMIT 1 OFFSET 7";
        ...
        <div class="container jumbotron-detail uncharted p-5 mb-2 rounded-3 d-flex justify-content-center">
        <div class="container-fluid">
        ...
        <div class="container movies-detail">
            <div class="row">
                ...
                <div class="col-6 movie-description">
                    ...
                    <a style="margin-top: 20px;" href="../schedule_bymovie.php?name=UNCHARTED" class="btn btn-primary to-schedule">
                        Buy Ticket
                    </a>
                </div>
                <div class="col-3 trailer">
                    <h4 class="trailer-title"><b>Trailer</b></h4>
                    <iframe class="div-round" src="https://www.youtube.com/embed/eHp3MbsCbMg" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                </div>
            </div>
        </div>
